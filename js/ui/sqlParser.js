(function() {
    ...
    hyryx.manage.sqlParser = function() {
        hyryx.screen.AbstractUITemplatePlugin.apply(this, arguments);
    };

    hyryx.manage.sqlParser.prototype = extend(hyryx.screen.AbstractUITemplatePlugin, {
    render : function(callback) {
        $.get('templates/sqlParser.mst', function(template) {
    ...
    init : function() {    
        ...
        //////////////////////////////////////////////////
        // Load sample queries
        $.get('sqlParser/sample-queries.sql', function(data) {
